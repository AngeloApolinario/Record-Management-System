    ...
    <style>
      ...
      * {
      ...
      @media (max-width: 768px) {
        .login-box {
          width: 80%; /* Make the login box take up more width on smaller screens */
      ...
      @media (max-width: 480px) {
        .login-box {
          width: 90%; /* Make the login box take up almost full width on very small screens */
          padding: 20px; /* Further reduce padding */
        }

        .logo {
          width: 70px; /* Further reduce the logo size */
        }

        .login-box h2 {
          font-size: 20px; /* Reduce heading size more */
        }
