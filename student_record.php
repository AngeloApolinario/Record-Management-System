...
try {
    $con = mysqli_connect($database, $user, $password, $databasename);
    if (!$con) {
...
function getManagementDetails($con) {
...
$managementDetails = getManagementDetails($con);
$fields = mysqli_fetch_fields(mysqli_query($con, "SELECT * FROM management")); 
?>
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Cinia's Carnival</title>
    <link rel="stylesheet" href="css2/list.css">
    <link rel="stylesheet" href="css2/viking.css">
...
<body>
    <header>
        <ul class="navbar">
            <li><a href="SecondPage.php" class="return-button">Return</a></li>
            <li><a href="#Rides">Maintenance</a></li>
            <li><a href="#Rides">Equipment</a></li>
            <li><a href="#Rides">Supplies</a></li>
            <li><a href="#Rides">Quantity</a></li>
            <li><a href="#Rides">Quality</a></li>
        </ul>
    </header>

    <section>
        <div class="list-title" id="list-rides">Management Details</div>
        <div class="management-list">
            <?php if (!empty($managementDetails)): ?>
                <table class="student-table">
                    <thead>
                        <tr>
                            <?php
                    ...
                    <tbody>
                        <?php
                        foreach ($managementDetails as $row) {
                            echo "<tr>";
                            foreach ($row as $cell) {
            ...
            <?php else: ?>
                <p>No management details found.</p>
            <?php endif; ?>
        </div>
    </section>
</body>
