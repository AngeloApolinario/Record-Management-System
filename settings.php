...
if (isset($_SESSION['teacher_name'])) {
  ...
  $sql_query = "SELECT contact_info, username, password from teachers where teacher_name like ?";
  $stmt = $conn->prepare($sql_query);
  $stmt->bind_param('s', $teacher_name_result);
  $stmt->execute();
  ...
  <div class="settings-container">
    <div class="settings-section">
      ...
      <div class="settings-item">
        ...
        <input type="text" id="profile-name" placeholder="Enter your name" value="<?php echo $teacher_name_result; ?>" />
      </div>
      <div class="settings-item">
