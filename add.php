...
if (isset($_POST['submit_button'])) {
    ...
    $sql = "INSERT INTO students (student_Id, first_name, last_name, dob, gender, phone, email, home_address, grade_level, enrollment_date, emergency_contacts, parent_names, parent_contact) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)";

    $stmt = $conn->prepare($sql);
    if ($stmt) {
        $stmt->bind_param("sssssssssssss", $student_id, $first_name, $last_name, $dob, $gender, $phone, $email, $home_address, $grade_level, $enrollment_date, $emergency_contacts, $parent_names, $parent_contact);
